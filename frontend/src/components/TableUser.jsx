...
const UserTable = ({ data, onEdit, onDelete }) => {
	...
	const handleDeleteConfirm = (id_user) => {
		setConfirmDeleteId(id_user);
	};
				...
				<table className="min-w-full bg-white border border-gray-300 text-center">
					<thead>
						<tr className="bg-cyan-800 text-white">
							...
							<th className="border border-gray-300 px-4 py-2">Nama Admin</th>
